...
const Testimonials: React.FC = () => {
    ...
    return (
        <div className="px-6 lg:px-20 my-16">
            {/* Heading */}
                    ...
                    <div className="flex justify-center gap-4 mt-10">
                        {/*                         
                         <Link href={"/testimonial"}>
                           <button className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow">
                            Add Yours
                        </button>
                        </Link> */}

                        <GradientButton href="/testimonial">
                            Add Yours
                        </GradientButton>
