...
export default function Footer() {
    ...
    const socialLinks = [
        ...
        { href: "https://www.facebook.com/tezcai", icon: <SiFacebook />, label: "Facebook" },
        { href: "https://www.tiktok.com/@tezcai.com", icon: <SiTiktok />, label: "TikTok" },
        { href: "https://www.linkedin.com/company/tezcai-com", icon: <SiLinkedin />, label: "LinkedIn" },
        { href: "https://www.youtube.com/@Tezcai", icon: <SiYoutube />, label: "YouTube" },
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                            ...
                            {companyLinks.map((link, index) => (
                                <li key={index}>
                                    <Link href={link.href} className="hover:text-blue-400 transition-colors flex items-center">
                                        ...
                                        <FiArrowRight className="ml-1 w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                                    </Link>
                                </li>
                            ))}
                        </ul>
                    ...
                    >
                        ...
                        <p className="mt-4 text-lg">
                            Tezcai is owned by Saadah Investment LLC, Abu Dhabi (UAE) based company.
                        </p>
                    </motion.div>
                </div>
                ...
                >
                    <div className="text-sm text-center">
                        <p>© {new Date().getFullYear()} Tezcai. All rights reserved.</p>
                    </div>
                </motion.div>
            </div>
        </footer>
