            ...
            <div className="px-6 lg:px-20 my-10">
                ...
                <div className="grid gap-8 max-w-lg w-full mx-auto lg:grid-cols-3 lg:max-w-full auto-rows-fr">
                    {testimonials.map((t) => (
                        <div
                            key={t.id}
                            className="p-6 rounded-xl border border-gray-300 bg-background shadow-sm flex flex-col justify-between h-full"
                        >
                ...
                <div className="mt-10">
                    <CreateTestimonial onSuccess={handleAddTestimonial} />
                </div>
            </div>
        </section>
    );
